...
//   });
  ...
  it("part 2: should return the sum of horizontal position and depth based on aim", () => {
    // ARRANGE
    const simpleDataset: Day2Input = [
      ["forward", 5],
      ["down", 5],
    ...
    const day2Part2Result = 2134882034;
    // ACT
    const result = getPosition(simpleDataset);
    const complexResult = getPosition(input as Day2Input);
    // ASSERT
    expect(result).toEqual(900);
    expect(complexResult).toEqual(day2Part2Result);
  });
});
